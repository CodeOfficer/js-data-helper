...
| f.js_data | *none* | yes | Used inside of a form builder, the dom_id param will be inferred through the builder and refer to the ID of the form. |
| js_data_functions | :framework | *none* | Used in your layout file just before the end BODY tag. Outputs Javascript inline to insert data into your DOM. |
