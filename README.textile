...
|_. helper |_. param |_. param |_. notes |
| js_data_tag | "dom_id" | &block | Used anywhere, the string param represents the dom_id|
| f.js_data | &block | | Used inside of a form builder, the dom_id param will be inferred through the builder |
